...
public final class HondaConstants {
    ...
    public static final String PREFERENCE_MEDIA_PLAYER = "jp.co.zenrin.music.HondaConstants.MEDIA_PLAYER";
    public static final String PREFERENCE_TRACK_LIST = "jp.co.zenrin.music.HondaConstants.TRACK_ARRAY_LIST";
    public static final String PREFERENCE_TRACK_INDEX = "jp.co.zenrin.music.HondaConstants.TRACK_INDEX";
    public static final String PREFERENCE_MPL_SERVICE_STATUS = "MPL_SERVICE_STATUS";

    //
    public static final String BROADCAST_AI_RECOMMEND = "jp.co.zenrin.music.HondaConstants.BROADCAST_AI_RECOMMEND";
